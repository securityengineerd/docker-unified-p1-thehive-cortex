...
## ============================================================
## RESTORE SCRIPT FOR CORTEX APPLICATION STACK
## ============================================================
## PURPOSE:
## This script restores a backup of Cortex application stack, 
...
##
## WARNING:
## - This script ensure Nginx, Elasticsearch, and Cortex services are stopped before performing the restore, and then restarts the services.
