...
## ============================================================
## BACKUP SCRIPT FOR CORTEX APPLICATION STACK
## ============================================================
## PURPOSE:
## This script creates a backup of Cortex application stack, 
...
## - Services (Nginx, Elasticsearch and Cortex) will be stopped during 
...
mkdir -p ${BACKUP_FOLDER}/{cortex,elasticsearch,nginx,certificates}
